...
def wrs(queue1: multiprocessing.Queue,queue2: multiprocessing.Queue,queue3: multiprocessing.Queue):
    file_path="grouping_and_picking_two_images_six_objects.pkl"
            ...
            while True:
                ...
                if q is not None:
                    if q[0] is not None and q[1] is not None and q[2] is not None and q[3] is not None:
                        ...
                        # print(f"animation_data.jaw_width:{animation_data.jaw_width}")
    
                        if animation_data.jaw_width < 0.08 and animation_data.current_jaw_width == 0:
                            # print("close_griper")
                            rbt_socket.close()
