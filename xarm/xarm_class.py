import math
import numpy as np
from wrs.robot_sim.end_effectors.grippers.xarm_gripper import xarm_gripper as xg
from wrs.robot_sim.end_effectors.multifinger.xhand import xhand_right as xhr
from wrs.robot_sim.manipulators.xarm7 import xarm7 as x7
from wrs.robot_sim.robots import single_arm_robot_interface as ri
...
class XArm7XG(ri.SglArmRobotInterface):
    def __init__(self, pos=np.zeros(3), rotmat=np.eye(3), name='xarm7_xg', enable_cc=True):
        ...
        self.end_effector=xhr.XHandRight(pos=self.manipulator.gl_flange_pos,
